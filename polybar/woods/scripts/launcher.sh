...
#rofi -no-config -no-lazy-grab -show drun -modi drun -theme ~/.config/polybar/woods/scripts/rofi/launcher.rasi
rofi -no-config -no-lazy-grab -show drun -modi drun -theme ~/.cache/wal/colors-rofi-dark.rasi
